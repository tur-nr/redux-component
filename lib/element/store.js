(function(global, document) {
  ...
  prototype.createdCallback = function createdCallback() {
    ...
    document.addEventListener('DOMContentLoaded', (function(reduxStore) {
      return function() {
        // create new redux store
        store = Redux.createStore(buildReducer.bind(reduxStore)(), {});
        // subscribe to state changes and emit an element event
        store.subscribe(reduxSubscriber.bind(reduxStore));
        // expose store dispatch
        Object.defineProperty(reduxStore, 'dispatch', {
          enumerable: true,
          value: store.dispatch
        });
        // set state from store to element
        Object.defineProperty(reduxStore, 'state', {
          enumerable: true,
